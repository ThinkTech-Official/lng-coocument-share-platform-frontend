  ...
  return (
    <div className="relative">
      ...
      <div className="mb-6 text-center">
        <h1 className="text-2xl md:text-4xl font-bold text-lng-blue">
          WELCOME
        </h1>
        <p className="text-sm md:text-base text-lng-grey">
      ...
      <form onSubmit={handleSubmit((data) => mutate(data))} noValidate className="space-y-5">
        ...
        <div className="flex flex-col gap-1">
          <label className=" font-medium text-lng-grey" htmlFor="login-password">
            Password
          </label>
          <div className="relative">
            <input
              ...
              disabled={isPending}
              className={[
                'w-full rounded border px-3 py-2 pr-10  text-lng-grey placeholder:text-gray-400',
        ...
        <div className="flex justify-end -mt-3">
          <Link
            to="/forgot-password"
            className="text-sm font-medium text-lng-red hover:text-lng-red-80 transition-colors"
          >
            Forgot password?
          </Link>
        </div>
        ...
        <Button
          ...
          loading={isPending}
          disabled={isPending}
          className="w-full rounded-full py-2.5 font-medium tracking-wide md:mb-10"
        >
          SIGN IN
        </Button>
      </form>
