...
import { LayoutDashboard, HardHat, Building2, Tag, FileText, Video, LogOut } from 'lucide-react';
...
function usePageTitle() {
  ...
  return navItems.find((item) => pathname.startsWith(item.to))?.label ?? 'Admin Portal';
}
